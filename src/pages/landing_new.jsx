          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="mb-8">
              <div className="animate-pulse">
                <h1 className="text-center text-4xl font-bold custom_underline">
                  Our Aims
                </h1>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6  shadow-[0_4px_6px_rgba(255,255,255,0.5)] rounded-lg">
                <FontAwesomeIcon
                  icon={faBriefcase}
                  className="text-7xl	 color_my mb-4"
                />
                <h2 className="text-xl color_my font-semibold mb-2">
                  Empowering Job Seekers
                </h2>
                <p className="color_my">
                  Connecting individuals with tailored opportunities to advance
              ...
              <div className="text-center p-6  shadow-[0_4px_6px_rgba(255,255,255,0.5)] rounded-lg">
                ...
                <p className="color_my">
                  Providing employers with efficient tools to discover and hire
              ...
              <div className="text-center p-6  shadow-[0_4px_6px_rgba(255,255,255,0.5)] rounded-lg">
                ...
                <p className="color_my">
                  Building a platform that nurtures professional growth and
